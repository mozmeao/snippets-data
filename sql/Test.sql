SELECT f.FXA_ID, f.EMAIL_ADDRESS_ as EmailAddress, f.EMAIL_ADDRESS_ as SubscriberKey, f.EMAIL_ADDRESS_, f.CREATED_DATE_ as CreatedDate, f.CREATED_DATE_ as LastActivity, f.FXA_LANGUAGE_ISO2

FROM Firefox_Account_ID f

WHERE  01-28-2019 < f.CREATED_DATE_ < 01-28-2019
